...
model = model.DNN(300, 52, 25).to(device)
...
path = "./profiling/dnn/table_"+ configs.environment_name +".txt"
text_file = open(path, "w")
text_file.write(txt)
text_file.close()

path = "./profiling/dnn/chromeTrace_"+ configs.environment_name +".json"
prof.export_chrome_trace(path)

path = "./profiling/dnn/profiler_stacks_cuda_"+ configs.environment_name +".txt"
prof.export_stacks(path, "self_cuda_time_total")

path = "./profiling/dnn/profiler_stacks_cpu_"+ configs.environment_name +".txt"
